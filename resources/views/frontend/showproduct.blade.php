        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 border-right">
                    <img src="{{asset('assets/uploads/product/'.$product->image)}}" class="w-100" alt="img">
                </div>
                <div class="col-md-8">
                    <h2 class="mb-0">
                        {{$product->name}}
                    ...
                    <hr>
                    <label class="me-3">Original Price : <s>RM {{$product->original_price}}</s> </label>
                    <label class="fw-bold">Selling Price : RM {{$product->selling_price}} </label>
